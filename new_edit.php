    ...
    <div class="content-wrapper content-wrapper--with-bg">
        ...
        <?php if ($_SESSION["name"]) { ?>
            ...
            <form action="update_query.php?id=<?php echo $id; ?>" method="post">
                ...
                <textarea name="etitle" id="text_title" cols="30" row="3"
                          style="margin-left: 49px; margin-block-end: auto;"><?php echo $title; ?></textarea>
                <br>
                <!-- email id field hide in blogs.php--->

                <!-- subject field -->
                <label for="brief">Subject :</label>
                <textarea name="esubject" id="text_subject" cols="30" rows="3"
                          style="margin-bottom: -13px;"><?php echo $subject; ?></textarea>
                <br>
                <br>
                <br>
                <!-- content field -->
